...
Para añadir un proyecto, incorpora un elemento al array `projects`. Su campo opcional `review` admite `quote`, `author` y `role`; la reseña aparecerá junto al proyecto. Publica únicamente opiniones reales con permiso de su autor. Los proyectos incluyen Caudal (plantilla de demostración para fontanería), la web de dir.sixFilms y el portfolio personal. La captura de Caudal está en `src/assets/projects/caudal.png` y enlaza a `https://plantilla-caudal.vercel.app/`. La captura real de dir.sixFilms está en `src/assets/projects/dir-sixfilms.png` y Astro la optimiza a WebP; al pulsarla se abre `https://dirweb.vercel.app/`. La tarjeta de colaboración no se presenta como un trabajo terminado.
...
Astro estático y TypeScript, con CSS y Tailwind. Tema oscuro inspirado en editores de código: superficies grafito, acentos azules y resaltado de sintaxis. Space Grotesk para títulos e Inter para textos, ambas variables y alojadas localmente. JetBrains Mono se reserva para los detalles del editor de código. Las licencias están en `public/fonts/OFL-SpaceGrotesk.txt`, `OFL-Inter.txt` y `OFL-JetBrainsMono.txt`. El componente `EditorProfile.astro` presenta el perfil como un panel de editor. Logos SVG locales de Simple Icons en `public/logos/`, con su licencia y procedencia; los servicios sin marca usan iconos descriptivos. Retrato optimizado por Astro a WebP en varios tamaños. La vista del portfolio personal está dibujada con HTML y CSS. Los enlaces utilizan marcas entre corchetes e iconos de ventana, y la invitación a colaborar lleva llaves con un destello, sin flechas de navegación.
